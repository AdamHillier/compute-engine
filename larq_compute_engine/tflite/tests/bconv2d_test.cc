...
void runTest(const TestParam& param) {
  ...
  BConv2DOpModel<PostType, TOutput> m_lce(
      ...
      post_tensor, post_tensor, threshold_tensor, input_depth, groups,
      stride_width, stride_height, bconv_padding, pad_values, activation,
  ...
  EXPECT_DEATH(
      {
        FP_BConv2DOpModel m_lce(
            ...
            threshold_tensor, 64, 1, 1, 1, Padding_SAME, 0,
  ...
  EXPECT_DEATH(
      {
        Bitpacked_BConv2DOpModel m_lce(
            ...
            post_tensor, threshold_tensor, 64, 1, 1, 1, Padding_SAME, 0,
