...
def _impl(ctx):
    ...
    if (ctx.attr.cpu == "armeabi"):
        ...
        # Comment by Tom: the "armeabi" and "local" version seem to be equivalent.
        # The compiler flags are only in a different order. I simply copied the "armeabi" version.
        unfiltered_compile_flags_feature = feature(
            name = "unfiltered_compile_flags",
            enabled = True,
            flag_sets = [
                    ...
                    flag_groups = [
                        flag_group(
                            ...
                            flags = [
                                "-std=c++11",
                                "-isystem",
                                "%{ARM_COMPILER_PATH}%/arm-rpi-linux-gnueabihf/include/c++/8.3.0/",
                                "-isystem",
                                "%{ARM_COMPILER_PATH}%/lib/gcc/arm-rpi-linux-gnueabihf/8.3.0/include",
                                "-isystem",
                                "%{ARM_COMPILER_PATH}%/lib/gcc/arm-rpi-linux-gnueabihf/8.3.0/include-fixed",
                                "-isystem",
                ...
                flag_set(
                    ...
                    flag_groups = [
                        flag_group(
                            ...
                            # and that we remove /usr/include
                            flags = [
                                "-std=c++11",
                                "-isystem",
